...
export class createTables1600926763100 implements MigrationInterface {
  name = 'createTables1600926763100';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "job_application_status_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_ts" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_ts" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "name" character varying NOT NULL, CONSTRAINT "PK_fd56eda3f9f17ec86a76a6c0e7a" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `ALTER TABLE "job_post_entity" ADD CONSTRAINT "FK_e2926325e6ec5a7c9006bae191c" FOREIGN KEY ("platformId") REFERENCES "platform_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "job_application_entity" ADD CONSTRAINT "FK_2aa1c45713b11d6282d1cc5575c" FOREIGN KEY ("userId") REFERENCES "user_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "job_application_entity" ADD CONSTRAINT "FK_5aca7be4abd9b3df9fe746fb9ac" FOREIGN KEY ("statusId") REFERENCES "job_application_status_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "job_application_entity" ADD CONSTRAINT "FK_00bff32c51c4e502c7e87638124" FOREIGN KEY ("jobPostId") REFERENCES "job_post_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "job_application_entity" DROP CONSTRAINT "FK_00bff32c51c4e502c7e87638124"`
    );
    await queryRunner.query(
      `ALTER TABLE "job_application_entity" DROP CONSTRAINT "FK_5aca7be4abd9b3df9fe746fb9ac"`
    );
    await queryRunner.query(
      `ALTER TABLE "job_application_entity" DROP CONSTRAINT "FK_2aa1c45713b11d6282d1cc5575c"`
    );
