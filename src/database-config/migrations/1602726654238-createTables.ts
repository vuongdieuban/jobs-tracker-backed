...
export class createTables1602726654238 implements MigrationInterface {
    name = 'createTables1602726654238'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_ts" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_ts" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "firstName" character varying, "lastName" character varying, "email" character varying NOT NULL, CONSTRAINT "UQ_415c35b9b3b6fe45a3b065030f5" UNIQUE ("email"), CONSTRAINT "PK_b54f8ea623b17094db7667d8206" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "refresh_token_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_ts" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_ts" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "invalidated" boolean NOT NULL DEFAULT false, "expiryDate" TIMESTAMP NOT NULL, "userId" uuid, CONSTRAINT "PK_a78813e06745b2c5d5b9776bfcf" PRIMARY KEY ("id"))`);
